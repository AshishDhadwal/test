...
def perform_analysis(file):
    ...
    rdf = pd.DataFrame({'Sentence' : reviews, 'Sentiment' : sentiments, 'Polarity' : polarities, 'Subjectivity' : subjectivities}, columns = ['Review Content','Sentiment','Polarity','Subjectivity'])
